...
if (window.matchMedia('(min-width: 1025px)').matches) {
  ...
  // Hover state
  document.querySelectorAll('a, button, .skill-block, .video-card, .comm-card, .social-card, .soft-card, .placeholder-card, .int-card').forEach(el => {
...
const translations = {
  it: {
    ...
    hero_tag: 'AI DIRECTOR · CINEMATIC STORYTELLER · MILANO',
    ...
    stat_1: 'Strumenti AI<br>Padroneggiati',
    stat_2: 'Lingue<br>Parlate',
    stat_3: 'Visione<br>Cinematografica',
    scroll: 'SCORRI',
    ...
    about_p2: "Dalle terre ghiacciate di <strong>Idrako</strong> — il mio progetto musicale AI — ai lavori commerciali nel settore automotive di lusso, lavoro dove l'arte e la tecnologia si scontrano. Ogni progetto è un'occasione per spingere i limiti del possibile.",
    ...
    port_title_1: 'Lavori selezionati dal',
    port_title_2: 'mondo Idrako.',
    tab_music: 'Video Musicali',
    tab_cinematic: 'Reel Cinematografici',
  ...
  en: {
    ...
    stat_1: 'AI Tools<br>Mastered',
    stat_2: 'Languages<br>Spoken',
    stat_3: 'Cinematic<br>Vision',
    scroll: 'SCROLL',
    ...
    about_p2: "From the icy realms of <strong>Idrako</strong> — my AI music project — to commercial work in the luxury automotive sector, I work where art and technology collide. Every project is a chance to push what's possible.",
    ...
    sec_portfolio: 'PORTFOLIO',
    port_title_1: 'Selected works from',
    port_title_2: 'the Idrako universe.',
    tab_music: 'Music Videos',
    tab_cinematic: 'Cinematic Reels',
...
document.querySelectorAll(
  ...
  '.skill-block, .soft-card, .video-card, .placeholder-card, .comm-card, ' +
...
if (dragon) {
  window.addEventListener('scroll', () => {
    ...
    if (y < window.innerHeight) {
      dragon.style.transform = `translate(-50%, calc(-50% + ${y * 0.3}px)) scale(${1 + y * 0.0003})`;
      dragon.style.opacity = Math.max(0, 0.4 - y * 0.001);
    }
  }, { passive: true });
}
